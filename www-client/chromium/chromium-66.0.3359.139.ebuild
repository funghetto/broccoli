...
IUSE="+official +extensions debug oculus nacl profiling vr vulkan wayland +fieldtrial-testing-like-official vr-data asan unsafedevfeatures +gtk3 +system-libpng +system-zlib vaapi 
	  ...
	  +system-ffmpeg +system-icu +system-libvpx +tcmalloc widevine +lld"
	  
RESTRICT="!system-ffmpeg? ( proprietary-codecs? ( bindist ) )"
REQUIRED_USE="
	debug? ( !official )
	debug-devtools? ( debug !official )
	official? ( lld !debug !debug-devtools !profiling fieldtrial-testing-like-official cfi !component-build extensions !asan !unsafedevfeatures )
