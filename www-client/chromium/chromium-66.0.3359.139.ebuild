...
IUSE="+official +extensions debug oculus nacl openvr profiling vr vulkan wayland +fieldtrial-testing-like-official vr-data asan unsafedevfeatures +gtk3 +system-libdrm +system-libpng +system-zlib vaapi 
	  +system-lcms gcc +cfi +pdf +plugins debug-devtools strip-debug-symb component-build cups gnome-keyring +hangouts jumbo-build kerberos neon pic +proprietary-codecs pulseaudio selinux +suid 
...
REQUIRED_USE="
	...
	official? ( !debug !debug-devtools !profiling fieldtrial-testing-like-official plugins pdf cfi !component-build extensions !asan !unsafedevfeatures )
